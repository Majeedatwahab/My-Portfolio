                ...
                <nav className="hidden md:flex space-x-8">
                    {["home", "about", "skills", "projects", "blog", "contact"].map((item) => (
                        <button
                            ...
                            className="text-gray-300 hover:text-white uppercase text-sm tracking-wider transition-colors"
                        >
                            {item}
                        </button>
                    ))}
                    ...
                    <nav className="flex flex-col items-center justify-center h-full space-y-8">
                        {["home", "about", "skills", "projects", "blog", "contact"].map((item) => (
                            <button
                                key={item}
                                onClick={() => scrollToSection(item)}
                                className="text-gray-300 hover:text-white uppercase text-lg tracking-wider transition-colors"
                            >
                                {item}
                            </button>
                        ))}
