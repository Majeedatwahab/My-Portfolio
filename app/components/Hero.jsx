        ...
        <section id="home" className="relative h-screen flex flex-col justify-center items-center">
            ...
            <div className="container mx-auto px-4 text-center z-10">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                    <a href="#projects">
                        <Button className="bg-gradient-to-r from-purple-600 to-cyan-600 hover:from-purple-700 hover:to-cyan-700 text-white px-8 py-6 rounded-md">
                            View My Work
                        </Button>
                    </a>
                    ...
                    <a href="#contact">
                        <Button
                            variant="outline"
                            className="border-purple-500 text-black hover:bg-purple-500/20 hover:text-white px-8 py-6 rounded-md"
                        >
                            Contact Me
                        </Button>
                    </a>
            ...
            >
                <ArrowDown className="h-10 w-10 text-purple-500" />
            </button>
        </section>
    )
}
